...
class App():
    ...
    def __init__(self):
        ...
        self.bt2 = Button(self.root, text="Start", command=self.start, font=("Courier 12 bold"))
        self.bt3 = Button(self.root, text="Start", command=self.start, font=("Courier 12 bold"))
        self.lb.place(x = 160, y=10)
        self.bt1.place(x=130, y=100)
        self.bt2.place(x=255, y=100)
        self.bt1.place(x=370, y=100)
a = App()